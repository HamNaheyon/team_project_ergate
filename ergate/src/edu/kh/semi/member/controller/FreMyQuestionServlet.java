...
@WebServlet("/fre_myQuestion/*")
public class FreMyQuestionServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String command = uri.substring((contextPath + "/fre_myQuestion/").length());
		...
		try {
			...
			if (command.equals("list")) {
				 ...
				 path = "/WEB-INF/views/member/fre_myQuestion.jsp"; 
